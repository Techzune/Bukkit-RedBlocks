...
public class RedBlock implements Serializable {
	...
	private final List<Material> specialBList;

	public RedBlock(final Location location, final int typeId, final byte data, final String owner, final boolean protect, final boolean inverted) {
	...
	private List<Material> getSpecialBlocks() {
		final List<Material> mat = new ArrayList<Material>();
		mat.add(Material.ACTIVATOR_RAIL);
		mat.add(Material.ANVIL);
		mat.add(Material.BED_BLOCK);
		mat.add(Material.BROWN_MUSHROOM);
		mat.add(Material.CACTUS);
		mat.add(Material.CAKE_BLOCK);
		mat.add(Material.CROPS);
		mat.add(Material.DETECTOR_RAIL);
		mat.add(Material.DIODE_BLOCK_OFF);
		mat.add(Material.DIODE_BLOCK_ON);
		mat.add(Material.FLOWER_POT);
		mat.add(Material.ITEM_FRAME);
		mat.add(Material.SUGAR_CANE_BLOCK);
		mat.add(Material.REDSTONE_WIRE);
		mat.add(Material.REDSTONE_COMPARATOR_OFF);
		mat.add(Material.REDSTONE_COMPARATOR_ON);
		mat.add(Material.REDSTONE_TORCH_OFF);
		mat.add(Material.REDSTONE_TORCH_ON);
		mat.add(Material.PAINTING);
		mat.add(Material.POWERED_RAIL);
		mat.add(Material.WOOD_DOOR);
		mat.add(Material.IRON_DOOR_BLOCK);
		return mat;
	}
}
